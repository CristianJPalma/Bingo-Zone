...
try {
    ...
    $stmt = $pdo->prepare("UPDATE partida SET numero_balotas = :numero_balotas, modo_juego = :modo_juego, numero_cartones = :numero_cartones, redirigir = 1 WHERE codigo_partida = :codigo_partida");
    $stmt->execute([
